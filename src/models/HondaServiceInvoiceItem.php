...
class HondaServiceInvoiceItem extends Model {
	...
	public function serviceInvoice() {
		return $this->belongsTo('Abs\ServiceInvoicePkg\HondaServiceInvoice', 'service_invoice_id', 'id');
	}
	...
	public function taxes() {
		return $this->belongsToMany('Abs\TaxPkg\Tax', 'honda_service_invoice_item_tax', 'service_invoice_item_id', 'tax_id')->withPivot(['percentage', 'amount']);
	}
	...
	public static function createFromObject($record_data, $company = null) {
		...
		$service_invoice = HondaServiceInvoice::where('number', $record_data->service_invoice_number)->where('company_id', $company->id)->first();
		if (!$service_invoice) {
