                        ...
                        foreach ($service_invoice->serviceInvoiceItems as $key => $serviceInvoiceItem) {
                            ...
                            if (!empty($service_invoice->outlets) && !empty($serviceInvoiceItem->serviceItem->taxCode)) {
                                ...
                                $service_invoice_details[] = [
                                    ...
                                    (!empty($service_invoice->address->gst_number) && !empty($service_invoice->address->gst_number))? 'B2B' : 'B2C',
                                    ...
                                    $serviceInvoiceItem->serviceItem ? $serviceInvoiceItem->serviceItem->taxCode->code : '',
